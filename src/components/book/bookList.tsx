...
//     e.preventDefault();
//     if (editFormData) {
//       fetch(`/api/books/update/${editFormData._id}`, {
//           method: 'PUT',
//           headers: {
...
const BookList: React.FC = () => {
  ...
  const handleEditFormChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    //   newFormData[fieldName as keyof Book] = fieldValue;
    //   setEditFormData(newFormData as Book);
    // }
  };
                  ...
                  <React.Fragment>
                    ...
                    <td>
                      <input
                        ...
                        defaultValue={book.rental_duration}
                        onChange={handleEditFormChange}
                      />
                    </td>
                    <td>
